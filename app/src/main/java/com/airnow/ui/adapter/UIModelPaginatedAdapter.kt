...
/**
 * Generic [RecyclerView.Adapter] for [DiffableUIModel]s.
 */
class UIModelPaginatedAdapter(
    ...
    override fun submitList(pagedList: PagedList<DiffableUIModel<in RecyclerView.ViewHolder>>?) {
        launch {
...
typealias BaseUIModelAlias = DiffableUIModel<in RecyclerView.ViewHolder>